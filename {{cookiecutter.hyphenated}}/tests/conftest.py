...
from {{ cookiecutter.underscored }}.utils import console, {{ cookiecutter.capwords }}Config
...
def debug():
    ...
    def _debug_inner(value: str | Path, label: str = "", breakpoint: bool = False, width: int = 80):
        """Print debug information to the console. This is used to debug tests while writing them.
...
def mock_config():
    ...
    Usage:
        def test_something(mock_config):
            ...
            with {{ cookiecutter.underscored.capitalize() }}Config.change_config_sources(mock_config(some_key="some_value")):
